insert into user (id,username,password,first_name,last_name,role) values (1,'user','$2a$06$/zpn1QuDr6QmJMnNm/oXyuQoKxmRkE3qhlKGAywFRtK03FelDd3AW','Tomasz','Dębski','ROLE_USER');
...
insert into product (id, name,description, category_product_id,product_number) values (9,'PANADOL NOC TABLETKI 20 SZ','Tabletki Panadol Night łączą skuteczną lekarstwę Paracetamolu z delikatnymi właściwościami uspokajającymi chlorowodorku anty-histaminy - difenhydraminy. Dają ulgę nocną w bólach mięśniowych, bólach pleców, bólach głowy, bólach głowy, bólach okresowych, zimnych i grypowych. .',21,'M_PR_8');
insert into product_package (id,product_id,name,price) values (110,9,'8',10.0);
insert into product (id, name,description, category_product_id,product_number) values (10,'PANADOL NOC TABLETKI 20 SZ','Tabletki Panadol Night łączą skuteczną lekarstwę Paracetamolu z delikatnymi właściwościami uspokajającymi chlorowodorku anty-histaminy - difenhydraminy. Dają ulgę nocną w bólach mięśniowych, bólach pleców, bólach głowy, bólach głowy, bólach okresowych, zimnych i grypowych. .',21,'M_PR_8');
insert into product_package (id,product_id,name,price) values (120,10,'8',10.0);
insert into product (id, name,description, category_product_id,product_number) values (11,'PANADOL NOC TABLETKI 20 SZ','Tabletki Panadol Night łączą skuteczną lekarstwę Paracetamolu z delikatnymi właściwościami uspokajającymi chlorowodorku anty-histaminy - difenhydraminy. Dają ulgę nocną w bólach mięśniowych, bólach pleców, bólach głowy, bólach głowy, bólach okresowych, zimnych i grypowych. .',21,'M_PR_8');
insert into product_package (id,product_id,name,price) values (130,11,'8',10.0);
insert into product (id, name,description, category_product_id,product_number) values (12,'PANADOL NOC TABLETKI 20 SZ','Tabletki Panadol Night łączą skuteczną lekarstwę Paracetamolu z delikatnymi właściwościami uspokajającymi chlorowodorku anty-histaminy - difenhydraminy. Dają ulgę nocną w bólach mięśniowych, bólach pleców, bólach głowy, bólach głowy, bólach okresowych, zimnych i grypowych. .',21,'M_PR_8');
...
insert into product (id, name,description, category_product_id,product_number) values (101,'Active Plast Energy na wzrost energii i dobre samopoczucie dla kobiet i mężczyzn','Plastry ENERGY zawierają naturalne składniki tradycyjnie stosowane na wzrost energii i dobre samopoczucie.',31,'V_EV_1');
